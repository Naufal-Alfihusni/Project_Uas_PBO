...
<html lang="id">
    <head>
        ...
        <title>Login Staff | The Grand Resto</title>
    ...
    <body>
        ...
        <div class="glass-card text-center">
            <div class="resto-logo">THE GRAND</div>
            <div class="sub-title">Resto & Lounge</div>
            ...
            <div class="footer-text">
                &copy; 2026 The Grand Resto Management. Secured Access.
            </div>
        </div>
